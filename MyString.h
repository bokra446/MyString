...
#include "StringRepresentation.h"
  ...
  public:
      ...
      */
      ...
      unsigned int sizeAfterOperation(const MyString& other) const;
     // friend AtException::AtException(int idx, int size);
      //friend InsertException::InsertException(int idx, int size);
  private:
      //char* _data;
      //unsigned int _size;
      class AtException;
